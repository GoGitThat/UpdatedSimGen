...
// Entry rule entryRuleprojectPath
entryRuleprojectPath returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getProjectPathRule()); }
	iv_ruleprojectPath=ruleprojectPath
	{ $current=$iv_ruleprojectPath.current; }
	EOF;

// Rule projectPath
ruleprojectPath returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleautoBuilding
entryRuleautoBuilding returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAutoBuildingRule()); }
	iv_ruleautoBuilding=ruleautoBuilding
	{ $current=$iv_ruleautoBuilding.current; }
	EOF;

// Rule autoBuilding
ruleautoBuilding returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		(
			(
				lv_autobuilding_2_0=RULE_BOOLEAN
				{
...
@after {
	...
	(
		...
		(
			(
				lv_authorString_2_0=RULE_STRING
				{
...
// Entry rule entryRulePurpose
entryRulePurpose returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getPurposeRule()); }
	iv_rulePurpose=rulePurpose
	{ $current=$iv_rulePurpose.current; }
	EOF;

// Rule Purpose
rulePurpose returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		(
			(
				lv_purposeString_2_0=RULE_STRING
				{
...
@after {
	...
	(
		...
		(
			(
				lv_settingsFilename_2_0=RULE_STRING
				{
