...
public class UnitySemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == UnityPackage.eINSTANCE)
			...
			case UnityPackage.PORT:
				...
				return; 
			case UnityPackage.PURPOSE:
				sequence_Purpose(context, (Purpose) semanticObject); 
				return; 
			...
			case UnityPackage.REAL_LITERAL:
				...
				return; 
			case UnityPackage.ROTATE:
				sequence_Rotate(context, (Rotate) semanticObject); 
				return; 
			case UnityPackage.SETTINGS:
			...
			case UnityPackage.VAR_TYPE:
				...
				return; 
			case UnityPackage.AUTO_BUILDING:
				sequence_autoBuilding(context, (autoBuilding) semanticObject); 
				return; 
			case UnityPackage.INTERFACE_TYPE:
				sequence_interfaceType(context, (interfaceType) semanticObject); 
				return; 
			case UnityPackage.PROJECT_PATH:
				sequence_projectPath(context, (projectPath) semanticObject); 
				return; 
			}
	 ...
	 *
	 * Constraint:
	 *     (name=ID payload=Payload? returnPayload=Payload? expressions+=Expression* description=Purpose?)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID propertyType=VarType range=Range? configurable=BOOLEAN?)
	 */
	...
	protected void sequence_Author(ISerializationContext context, Author semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UnityPackage.Literals.AUTHOR__AUTHOR_STRING) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UnityPackage.Literals.AUTHOR__AUTHOR_STRING));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getAuthorAccess().getAuthorStringSTRINGTerminalRuleCall_2_0(), semanticObject.getAuthorString());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (focusObject=[Instance|ID] (dx=REAL dy=REAL dz=REAL)?)
	 */
	 ...
	 *     (
	 *         name=ID 
	 *         (kind='car' | kind='rover' | kind='generic' | kind='others' | kind='decoration') 
	 *         properties+=Attribute? 
	 *         (actions+=Action? properties+=Attribute?)*
	 *     )
	 */
	...
	/**
	 * Contexts:
	 *     Purpose returns Purpose
	 *
	 * Constraint:
	 *     purposeString=STRING
	 */
	protected void sequence_Purpose(ISerializationContext context, Purpose semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UnityPackage.Literals.PURPOSE__PURPOSE_STRING) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UnityPackage.Literals.PURPOSE__PURPOSE_STRING));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPurposeAccess().getPurposeStringSTRINGTerminalRuleCall_2_0(), semanticObject.getPurposeString());
		feeder.finish();
	}
	...
	protected void sequence_RealLiteral(ISerializationContext context, RealLiteral semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UnityPackage.Literals.REAL_LITERAL__REAL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UnityPackage.Literals.REAL_LITERAL__REAL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRealLiteralAccess().getRealREALTerminalRuleCall_1_0(), semanticObject.getReal());
		feeder.finish();
	}
	...
	protected void sequence_Rotate(ISerializationContext context, Rotate semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UnityPackage.Literals.ROTATE__DX) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UnityPackage.Literals.ROTATE__DX));
			if (transientValues.isValueTransient(semanticObject, UnityPackage.Literals.ROTATE__DY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UnityPackage.Literals.ROTATE__DY));
			if (transientValues.isValueTransient(semanticObject, UnityPackage.Literals.ROTATE__DZ) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UnityPackage.Literals.ROTATE__DZ));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRotateAccess().getDxREALTerminalRuleCall_2_0(), semanticObject.getDx());
		feeder.accept(grammarAccess.getRotateAccess().getDyREALTerminalRuleCall_4_0(), semanticObject.getDy());
		feeder.accept(grammarAccess.getRotateAccess().getDzREALTerminalRuleCall_6_0(), semanticObject.getDz());
		feeder.finish();
	}
	...
	protected void sequence_Settings(ISerializationContext context, Settings semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UnityPackage.Literals.SETTINGS__SETTINGS_FILENAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UnityPackage.Literals.SETTINGS__SETTINGS_FILENAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getSettingsAccess().getSettingsFilenameSTRINGTerminalRuleCall_2_0(), semanticObject.getSettingsFilename());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     autoBuilding returns autoBuilding
	 *
	 * Constraint:
	 *     autobuilding=BOOLEAN
	 */
	protected void sequence_autoBuilding(ISerializationContext context, autoBuilding semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UnityPackage.Literals.AUTO_BUILDING__AUTOBUILDING) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UnityPackage.Literals.AUTO_BUILDING__AUTOBUILDING));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getAutoBuildingAccess().getAutobuildingBOOLEANTerminalRuleCall_2_0(), semanticObject.isAutobuilding());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     projectPath returns projectPath
	 *
	 * Constraint:
	 *     projPath=STRING
	 */
	protected void sequence_projectPath(ISerializationContext context, projectPath semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UnityPackage.Literals.PROJECT_PATH__PROJ_PATH) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UnityPackage.Literals.PROJECT_PATH__PROJ_PATH));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getProjectPathAccess().getProjPathSTRINGTerminalRuleCall_3_0(), semanticObject.getProjPath());
		feeder.finish();
	}
