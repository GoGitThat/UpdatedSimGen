 ...
 * </p>
 * <ul>
 *   <li>{@link cs.queensu.ca.unity.impl.InitImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InitImpl extends MinimalEObjectImpl.Container implements Init
{
  ...
  {
    return UnityPackage.Literals.INIT;
  }
  ...
  public EList<Expression> getExpressions()
  {
    if (expressions == null)
    {
      expressions = new EObjectContainmentEList<Expression>(Expression.class, this, UnityPackage.INIT__EXPRESSIONS);
    }
    return expressions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UnityPackage.INIT__EXPRESSIONS:
