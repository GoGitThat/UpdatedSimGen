 ...
 *   <li>{@link cs.queensu.ca.unity.impl.AttributeImpl#isConfigurable <em>Configurable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeImpl extends PropertyImpl implements Attribute
{
  ...
  public void setConfigurable(boolean newConfigurable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UnityPackage.ATTRIBUTE__CONFIGURABLE, oldConfigurable, configurable));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case UnityPackage.ATTRIBUTE__RANGE:
        return getRange();
      case UnityPackage.ATTRIBUTE__CONFIGURABLE:
