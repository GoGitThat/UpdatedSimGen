...
public class UnityPackageImpl extends EPackageImpl implements UnityPackage
{
   ...
   * @generated
   */
  private EClass autoBuildingEClass = null;
  ...
  public static UnityPackage init()
  {
    ...
    Object registeredUnityPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    UnityPackageImpl theUnityPackage = registeredUnityPackage instanceof UnityPackageImpl ? (UnityPackageImpl)registeredUnityPackage : new UnityPackageImpl();
   ...
   */
  @Override
  public EReference getAction_Description()
  {
   ...
   */
  @Override
  public EAttribute getAttribute_Configurable()
  {
   ...
   */
  @Override
  public EAttribute getRealLiteral_Real()
  {
   ...
   */
  @Override
  public EReference getENV_Focus()
  {
    return (EReference)envEClass.getEStructuralFeatures().get(6);
  }
   ...
   */
  @Override
  public EReference getENV_Rotate()
  {
    return (EReference)envEClass.getEStructuralFeatures().get(7);
  }
   ...
   */
  @Override
  public EReference getENV_Author()
  {
    return (EReference)envEClass.getEStructuralFeatures().get(8);
  }
   ...
   */
  @Override
  public EReference getENV_Purpose()
  {
    return (EReference)envEClass.getEStructuralFeatures().get(9);
  }
   ...
   */
  @Override
  public EReference getENV_Projectpath()
  {
    return (EReference)envEClass.getEStructuralFeatures().get(10);
  }
   ...
   */
  @Override
  public EReference getENV_Settings()
  {
    return (EReference)envEClass.getEStructuralFeatures().get(11);
  }
   ...
   */
  @Override
  public EReference getENV_AutoBuild()
  {
    return (EReference)envEClass.getEStructuralFeatures().get(12);
  }
   ...
   */
  @Override
  public EReference getFocus_FocusObject()
  {
   ...
   */
  @Override
  public EAttribute getRotate_Dx()
  {
   ...
   */
  @Override
  public EAttribute getRotate_Dy()
  {
   ...
   */
  @Override
  public EAttribute getRotate_Dz()
  {
   ...
   */
  @Override
  public EAttribute getprojectPath_ProjPath()
  {
    return (EAttribute)projectPathEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EClass getautoBuilding()
  {
    return autoBuildingEClass;
  }
   ...
   */
  @Override
  public EAttribute getautoBuilding_Autobuilding()
  {
    return (EAttribute)autoBuildingEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EAttribute getAuthor_AuthorString()
  {
   ...
   */
  @Override
  public EAttribute getPurpose_PurposeString()
  {
   ...
   */
  @Override
  public EAttribute getSettings_SettingsFilename()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(actionEClass, ACTION__DESCRIPTION);
    ...
    createEAttribute(attributeEClass, ATTRIBUTE__CONFIGURABLE);
    ...
    createEAttribute(realLiteralEClass, REAL_LITERAL__REAL);
    ...
    createEReference(envEClass, ENV__FOCUS);
    createEReference(envEClass, ENV__ROTATE);
    createEReference(envEClass, ENV__AUTHOR);
    createEReference(envEClass, ENV__PURPOSE);
    createEReference(envEClass, ENV__PROJECTPATH);
    createEReference(envEClass, ENV__SETTINGS);
    createEReference(envEClass, ENV__AUTO_BUILD);

    focusEClass = createEClass(FOCUS);
    createEReference(focusEClass, FOCUS__FOCUS_OBJECT);
    createEAttribute(focusEClass, FOCUS__DX);
    createEAttribute(focusEClass, FOCUS__DY);
    createEAttribute(focusEClass, FOCUS__DZ);

    rotateEClass = createEClass(ROTATE);
    createEAttribute(rotateEClass, ROTATE__DX);
    createEAttribute(rotateEClass, ROTATE__DY);
    createEAttribute(rotateEClass, ROTATE__DZ);

    projectPathEClass = createEClass(PROJECT_PATH);
    createEAttribute(projectPathEClass, PROJECT_PATH__PROJ_PATH);

    autoBuildingEClass = createEClass(AUTO_BUILDING);
    createEAttribute(autoBuildingEClass, AUTO_BUILDING__AUTOBUILDING);

    authorEClass = createEClass(AUTHOR);
    createEAttribute(authorEClass, AUTHOR__AUTHOR_STRING);

    purposeEClass = createEClass(PURPOSE);
    createEAttribute(purposeEClass, PURPOSE__PURPOSE_STRING);

    settingsEClass = createEClass(SETTINGS);
    createEAttribute(settingsEClass, SETTINGS__SETTINGS_FILENAME);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getAction_Description(), this.getPurpose(), null, "description", null, 0, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getAttribute_Configurable(), ecorePackage.getEBoolean(), "configurable", null, 0, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getRealLiteral_Real(), ecorePackage.getEDouble(), "real", null, 0, 1, RealLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getENV_Focus(), this.getFocus(), null, "focus", null, 0, 1, cs.queensu.ca.unity.ENV.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getENV_Rotate(), this.getRotate(), null, "rotate", null, 0, 1, cs.queensu.ca.unity.ENV.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getENV_Author(), this.getAuthor(), null, "author", null, 0, 1, cs.queensu.ca.unity.ENV.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getENV_Purpose(), this.getPurpose(), null, "purpose", null, 0, 1, cs.queensu.ca.unity.ENV.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getENV_Projectpath(), this.getprojectPath(), null, "projectpath", null, 0, 1, cs.queensu.ca.unity.ENV.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getENV_Settings(), this.getSettings(), null, "settings", null, 0, 1, cs.queensu.ca.unity.ENV.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getENV_AutoBuild(), this.getautoBuilding(), null, "autoBuild", null, 0, 1, cs.queensu.ca.unity.ENV.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(focusEClass, Focus.class, "Focus", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getFocus_FocusObject(), this.getInstance(), null, "focusObject", null, 0, 1, Focus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getFocus_Dx(), ecorePackage.getEDouble(), "dx", null, 0, 1, Focus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getFocus_Dy(), ecorePackage.getEDouble(), "dy", null, 0, 1, Focus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getFocus_Dz(), ecorePackage.getEDouble(), "dz", null, 0, 1, Focus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(rotateEClass, Rotate.class, "Rotate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getRotate_Dx(), ecorePackage.getEDouble(), "dx", null, 0, 1, Rotate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRotate_Dy(), ecorePackage.getEDouble(), "dy", null, 0, 1, Rotate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getRotate_Dz(), ecorePackage.getEDouble(), "dz", null, 0, 1, Rotate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(projectPathEClass, projectPath.class, "projectPath", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getprojectPath_ProjPath(), ecorePackage.getEString(), "projPath", null, 0, 1, projectPath.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(autoBuildingEClass, autoBuilding.class, "autoBuilding", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getautoBuilding_Autobuilding(), ecorePackage.getEBoolean(), "autobuilding", null, 0, 1, autoBuilding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(authorEClass, Author.class, "Author", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAuthor_AuthorString(), ecorePackage.getEString(), "authorString", null, 0, 1, Author.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(purposeEClass, Purpose.class, "Purpose", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getPurpose_PurposeString(), ecorePackage.getEString(), "purposeString", null, 0, 1, Purpose.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(settingsEClass, Settings.class, "Settings", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getSettings_SettingsFilename(), ecorePackage.getEString(), "settingsFilename", null, 0, 1, Settings.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
